...
0x00, 0x17, 0x00, // !
0X00, 0x10, 0x00, // .
0x1F, 0x0E, 0x04, // triangle
0x03, 0x00, 0x03, // "
0x01, 0x15, 0x02, // ?
0x10, 0x18, 0x00, // ,
0x00, 0x03, 0x00, // '
0x08, 0x0C, 0x08, // up arrow
0x01, 0x03, 0x01, // down arrow
0x00, 0x22, 0x00, // -
0x08, 0x05, 0x00, // ;
0x00, 0x05, 0x00  // :
};
...
Font3x5::Font3x5(/*uint8_t lineSpacing*/) {
  ...
  _cursorX = _cursorY = _baseX = _randomF = 0;
  //_textColor = 1;
...
void Font3x5::printChar(const char c, const int8_t x, int8_t y) {
  ...
  if (idx > -1) {
    ...
    if(random(0, 255) >= _randomF) {
    //if (_textColor == WHITE) {
      //arduboy.drawCompressed(x, y, font_images[idx])
...
void Font3x5::setRandom(const uint8_t r) {
  _randomF = r;
}
